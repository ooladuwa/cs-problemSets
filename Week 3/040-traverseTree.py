...
# create result list
# create queue list
# insert t into queue at index 0
# while queue
    # create root and set it equal to first thing popped off queue
    # if root, append value to result
    # if root.left not None, insert into queue
    # if root.right not None, insert into queue
# return result
"""
